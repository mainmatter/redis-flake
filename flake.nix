{
  ...
  inputs = {
    ...
    redis = {
      url = "git+ssh://git@github.com/redislabsdev/Redis.git?ref=rse_big2_8.6";
      flake = false;
    };
    ...
    speedb = {
      url = "git+ssh://git@github.com/redislabsdev/speedb-ent?rev=d52df54a12b45116e42163fc0f4e95ccf535ee41";
      flake = false;
    };
  };
